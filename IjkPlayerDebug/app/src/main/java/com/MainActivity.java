...
public class MainActivity extends Activity {
    ...
    public void compress(View view) {
        ...
        MediaProcess.getMediaProcess().getVideoCompress().videoCompress("/mnt/sdcard/rtmp.mp4", "rtmp://10.0.5.62:1935/rtmplive/room", 568, 320, new VideoCompress.CompressListener() {
            @Override
