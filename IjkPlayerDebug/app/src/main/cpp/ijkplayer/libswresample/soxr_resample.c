...
//
//static int process(
//        struct ResampleContext * c, struct AudioData *dst, int dst_size,
//        struct AudioData *src, int src_size, int *consumed){
//    size_t idone, odone;
...
//}
//
//static int invert_initial_buffer(struct ResampleContext *c, struct AudioData *dst, const struct AudioData *src,
