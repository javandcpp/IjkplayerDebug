...
static int multiple_resample(ResampleContext *c, struct AudioData *dst, int dst_size, struct AudioData *src, int src_size, int *consumed){
    int i;
...
static int resample_flush(struct SwrContext *s) {
    ResampleContext *c = s->resample;
    struct AudioData *a= &s->in_buffer;
    int i, j, ret;
...
static int invert_initial_buffer(ResampleContext *c, struct AudioData *dst, const struct AudioData *src,
