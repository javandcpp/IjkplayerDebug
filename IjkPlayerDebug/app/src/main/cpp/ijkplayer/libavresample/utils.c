...
static int handle_buffered_output(AVAudioResampleContext *avr,
                                  struct AudioData *output, struct AudioData *converted)
{
    int ret;
...
{
    struct AudioData input_buffer;
    struct AudioData output_buffer;
    struct AudioData *current_buffer;
