 ...
 */
static void calc_ptr_alignment(struct AudioData *a)
{
    int p;
    int min_align = 128;
...
int ff_audio_data_copy(struct AudioData *dst, struct AudioData *src, ChannelMapInfo *map)
{
    int ret, p;
