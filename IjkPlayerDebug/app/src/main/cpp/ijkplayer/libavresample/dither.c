...
struct DitherContext {
    ...
    struct AudioData *flt_data;        // input data in fltp
    struct AudioData *s16_data;        // dithered output in s16p
...
int ff_convert_dither(DitherContext *c, struct AudioData *dst, struct AudioData *src)
{
    int ret;
    struct AudioData *flt_data;
