 ...
 *
 * For each call, the alignment of the input and output struct AudioData buffers are
 ...
 */
int ff_audio_convert(AudioConvert *ac, struct AudioData *out, struct AudioData *in);
