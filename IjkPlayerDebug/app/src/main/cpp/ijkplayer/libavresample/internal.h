...
struct AVAudioResampleContext {
    ...
    struct AudioData *in_buffer;           /**< buffer for converted input         */
    struct AudioData *resample_out_buffer; /**< buffer for output from resampler   */
    struct AudioData *out_buffer;          /**< buffer for converted output        */
