                        ...
                        float *tmp0, float *tmp1)
{
    ...
    c->fft128.fft_permute(&c->fft128, (struct FFTComplex*)src);
    c->fft128.fft_permute(&c->fft128, (struct FFTComplex*)(src + 128));
    c->fft128.fft_permute(&c->fft128, (struct FFTComplex*)(src + 256));
    c->fft128.fft_permute(&c->fft128, (struct FFTComplex*)(src + 384));
    c->fft128.fft_calc(&c->fft128, (struct FFTComplex*)src);
    c->fft128.fft_calc(&c->fft128, (struct FFTComplex*)(src + 128));
    c->fft128.fft_calc(&c->fft128, (struct FFTComplex*)(src + 256));
    c->fft128.fft_calc(&c->fft128, (struct FFTComplex*)(src + 384));
    combine_fft(src, src + 128, src + 256, src + 384, tmp1,
                ff_on2avc_ctab_1, ff_on2avc_ctab_2,
                ff_on2avc_ctab_3, ff_on2avc_ctab_4, 512, 2);
    c->fft512.fft_permute(&c->fft512, (struct FFTComplex*)tmp1);
    c->fft512.fft_calc(&c->fft512, (struct FFTComplex*)tmp1);
                         ...
                         float *tmp0, float *tmp1)
{
    ...
    c->fft256.fft_permute(&c->fft256, (struct FFTComplex*)src);
    c->fft256.fft_permute(&c->fft256, (struct FFTComplex*)(src + 256));
    c->fft256.fft_permute(&c->fft256, (struct FFTComplex*)(src + 512));
    c->fft256.fft_permute(&c->fft256, (struct FFTComplex*)(src + 768));
    c->fft256.fft_calc(&c->fft256, (struct FFTComplex*)src);
    c->fft256.fft_calc(&c->fft256, (struct FFTComplex*)(src + 256));
    c->fft256.fft_calc(&c->fft256, (struct FFTComplex*)(src + 512));
    c->fft256.fft_calc(&c->fft256, (struct FFTComplex*)(src + 768));
    combine_fft(src, src + 256, src + 512, src + 768, tmp1,
                ff_on2avc_ctab_1, ff_on2avc_ctab_2,
                ff_on2avc_ctab_3, ff_on2avc_ctab_4, 1024, 1);
    c->fft1024.fft_permute(&c->fft1024, (struct FFTComplex*)tmp1);
    c->fft1024.fft_calc(&c->fft1024, (struct FFTComplex*)tmp1);
