...
void ff_fft_permute_sse(FFTContext *s, struct FFTComplex *z);
void ff_fft_calc_avx(FFTContext *s, struct FFTComplex *z);
void ff_fft_calc_sse(FFTContext *s, struct FFTComplex *z);
void ff_fft_calc_3dnow(FFTContext *s, struct FFTComplex *z);
void ff_fft_calc_3dnowext(FFTContext *s, struct FFTComplex *z);
