...
static void fft32_vsx_interleave(struct FFTComplex *z)
{
...
static void fft64_vsx_interleave(struct FFTComplex *z)
{
...
static void fft128_vsx_interleave(struct FFTComplex *z)
{
...
static void fft256_vsx_interleave(struct FFTComplex *z)
{
...
static void fft512_vsx_interleave(struct FFTComplex *z)
{
...
static void fft1024_vsx_interleave(struct FFTComplex *z)
{
...
static void fft2048_vsx_interleave(struct FFTComplex *z)
{
...
static void fft4096_vsx_interleave(struct FFTComplex *z)
{
...
static void fft8192_vsx_interleave(struct FFTComplex *z)
{
...
static void fft16384_vsx_interleave(struct FFTComplex *z)
{
...
static void fft32768_vsx_interleave(struct FFTComplex *z)
{
...
static void fft65536_vsx_interleave(struct FFTComplex *z)
{
...
static void fft32_vsx(struct FFTComplex *z)
{
    fft16_vsx(z);
    fft8_vsx(z+16);
    fft8_vsx(z+24);
...
static void fft64_vsx(struct FFTComplex *z)
{
    fft32_vsx(z);
    fft16_vsx(z+32);
    fft16_vsx(z+48);
...
static void fft128_vsx(struct FFTComplex *z)
{
    fft64_vsx(z);
    fft32_vsx(z+64);
    fft32_vsx(z+96);
...
static void fft256_vsx(struct FFTComplex *z)
{
    fft128_vsx(z);
    fft64_vsx(z+128);
    fft64_vsx(z+192);
...
static void fft512_vsx(struct FFTComplex *z)
{
    fft256_vsx(z);
    fft128_vsx(z+256);
    fft128_vsx(z+384);
...
static void fft1024_vsx(struct FFTComplex *z)
{
    fft512_vsx(z);
    fft256_vsx(z+512);
    fft256_vsx(z+768);
...
static void fft2048_vsx(struct FFTComplex *z)
{
    fft1024_vsx(z);
    fft512_vsx(z+1024);
    fft512_vsx(z+1536);
...
static void fft4096_vsx(struct FFTComplex *z)
{
    fft2048_vsx(z);
    fft1024_vsx(z+2048);
    fft1024_vsx(z+3072);
...
static void fft8192_vsx(struct FFTComplex *z)
{
    fft4096_vsx(z);
    fft2048_vsx(z+4096);
    fft2048_vsx(z+6144);
...
static void fft16384_vsx(struct FFTComplex *z)
{
    fft8192_vsx(z);
    fft4096_vsx(z+8192);
    fft4096_vsx(z+12288);
...
static void fft32768_vsx(struct FFTComplex *z)
{
    fft16384_vsx(z);
    fft8192_vsx(z+16384);
    fft8192_vsx(z+24576);
...
static void fft65536_vsx(struct FFTComplex *z)
{
    fft32768_vsx(z);
...
static void (* const fft_dispatch_vsx[])(struct FFTComplex*) = {
...
static void (* const fft_dispatch_vsx_interleave[])(struct FFTComplex*) = {
...
void ff_fft_calc_interleave_vsx(FFTContext *s, struct FFTComplex *z)
{
     fft_dispatch_vsx_interleave[s->nbits-2](z);
}
void ff_fft_calc_vsx(FFTContext *s, struct FFTComplex *z)
{
