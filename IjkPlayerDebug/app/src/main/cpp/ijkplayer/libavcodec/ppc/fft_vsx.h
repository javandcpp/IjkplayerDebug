...
#define byte_2complex (2*sizeof(struct FFTComplex))
#define byte_4complex (4*sizeof(struct FFTComplex))
#define byte_6complex (6*sizeof(struct FFTComplex))
#define byte_8complex (8*sizeof(struct FFTComplex))
#define byte_10complex (10*sizeof(struct FFTComplex))
#define byte_12complex (12*sizeof(struct FFTComplex))
#define byte_14complex (14*sizeof(struct FFTComplex))

inline static void pass_vsx_interleave(struct FFTComplex *z, const FFTSample *wre, unsigned int n)
{
    int o1 = n<<1;
    int o2 = n<<2;
    int o3 = o1+o2;
    ...
    n = n-2;
    i1 = o1*sizeof(struct FFTComplex);
    i2 = o2*sizeof(struct FFTComplex);
    i3 = o3*sizeof(struct FFTComplex);
...
inline static void fft2_vsx_interleave(struct FFTComplex *z)
{
    FFTSample r1, i1;
...
inline static void fft4_vsx_interleave(struct FFTComplex *z)
{
    vec_f a, b, c, d;
    float* out=  (float*)z;
    a = vec_ld(0, &(out[0]));
...
inline static void fft8_vsx_interleave(struct FFTComplex *z)
{
...
inline static void fft16_vsx_interleave(struct FFTComplex *z)
{
    float* out=  (float*)z;
...
inline static void fft4_vsx(struct FFTComplex *z)
{
    vec_f a, b, c, d;
    float* out=  (float*)z;
    a = vec_ld(0, &(out[0]));
...
inline static void fft8_vsx(struct FFTComplex *z)
{
    vec_f vz0, vz1, vz2, vz3;
...
inline static void fft16_vsx(struct FFTComplex *z)
{
    float* out=  (float*)z;
    vec_f vc0 = {0.0, 0.0, 0.0, 0.0};
    vec_f vc1 = {-sqrthalf, sqrthalf, sqrthalf, -sqrthalf};
...
inline static void pass_vsx(struct FFTComplex * z, const FFTSample * wre, unsigned int n)
{
    int o1 = n<<1;
    int o2 = n<<2;
    int o3 = o1+o2;
