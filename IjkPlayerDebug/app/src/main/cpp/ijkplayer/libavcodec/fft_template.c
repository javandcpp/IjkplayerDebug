...
//#endif /* FFT_FIXED_32 */
//
//static void fft_permute_c(FFTContext *s, struct FFTComplex *z);
//static void fft_calc_c(FFTContext *s, struct FFTComplex *z);
//
...
//            goto fail;
//    }
//    s->tmp_buf = av_malloc(n * sizeof(struct FFTComplex));
//    if (!s->tmp_buf)
//        goto fail;
//    s->inverse = inverse;
...
//
//    memcpy(z, s->tmp_buf, np * sizeof(struct FFTComplex));
//}
//
...
///* z[0...8n-1], w[1...2n-1] */
//#define PASS(name)\
//static void name(struct FFTComplex *z, const FFTSample *wre, unsigned int n)\
//{\
...
//static void fft##n(struct FFTComplex *z)\
//{\
//    fft##n2(z);\
//    fft##n4(z+n4*2);\
//    fft##n4(z+n4*3);\
...
//}
//
//static void fft4(struct FFTComplex *z)
//{
...
//}
//
//static void fft8(struct FFTComplex *z)
//{
//    FFTDouble t1, t2, t3, t4, t5, t6;
//
//    fft4(z);
...
//
//#if !CONFIG_SMALL
//static void fft16(struct FFTComplex *z)
//{
//    FFTDouble t1, t2, t3, t4, t5, t6;
...
//
//static void (* const fft_dispatch[])(struct FFTComplex*) = {
